...
$sph_messages =  Array (
	...
	"CATEGORIES" => "ÊÀÒÅÃÎÐÈÈ",
	"Untitled" => "Áåç íàçâàíèÿ",
	"Powered by" => "Powered by",
	"Previous" => "Ïðåäûäóùàÿ",
	"Next" => "Ñëåäóþùàÿ",
	"Result page" => "Ñòðàíèöà ðåçóëüòàòîâ",
	"Only in category" => "Òîëüêî â êàòåãîðèè",
	"Search" => "Èñêàòü",
	"All sites" => "Ñàéòû öåëèêîì",
	"Web pages" => "Âåá-ñòðàíèöû",
	"The search" => "Ïîèñê",
	"noMatch" => "Ðåçóëüòàòîâ íåò",
	"ignoredWords" => "Ñëåäóþùèå ñëîâà èãíîðèðîâàëèñü (ñëèøêîì êîðîòêèå èëè ÷àñòî âñòðå÷àþùèåñÿ):",
	"resultsFor" => "Ðåçóëüòàò :",
	"Results" => "Ðåçóëüòàòû", //
	"of" => " èç ",           //Pattern:  Results x-y of z match(es). Change according to the pattern
	"match" => "ñîâïàäåíèå",     //
	"matches" => "ñîâïàäåíèÿ", //
	"seconds" => "ñåê.",
	"andSearch" => "Èñêàòü âñå ñëîâà",
	"orSearch" => "Èñêàòü ëþáîå èç ñëîâ",
	"phraseSearch" => "Èñêàòü ôðàçó",
	"show" => "Ïîêàçàòü ",
	"resultsPerPage" => "ðåçóëüòàòîâ íà ñòðàíèöå",
