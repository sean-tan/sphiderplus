...
This file is modified [Tec] for proper co-operation with Sphider-plus.

************************************************************************/

    $PATH_TO_CLASS = dirname(ereg_replace("\\\\", "/", __FILE__)) . "/" . "charsets" . "/";
...
//        print "<br /> entered into Convert<br />";    
